# Downloaded from louiscaron's github project
# Scapy IEEE 1588 layer
# Modified by Shanghao Shi for PTP Security Project
# Contact shanghaos@vt.edu for questions and problems
...
class ieee1588v2_Announce(ieee1588v2_Header):
    ...
    fields_desc=[
            ...
            XByteField("grandmasterClockClass",0),
            XByteField("grandmasterClockAccuracy",0),
            XShortField("grandmasterClockVariance",0),
            ByteField("grandmasterPriority2",128),
            LongField("GrandmasterIdentity",0xe45),
...
class ieee1588v2_PDelay_Req(ieee1588v2_Header):
    ...
    fields_desc = [
        ieee1588v2_Header,
        TimestampField('originTimestamp', 0), TimestampField('reserved ', 0),
    ]
